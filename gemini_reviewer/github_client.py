...
class GitHubClient:
    ...
    def create_review(self, pr_details: PRDetails, comments: List[ReviewComment], event: str = "COMMENT") -> bool:
        """Create a review on GitHub with retry logic.
        
        Args:
            pr_details: Pull request details
            comments: List of review comments (can be empty)
        ...
        try:
            ...
            # Generate review body based on whether there are comments
            if github_comments:
